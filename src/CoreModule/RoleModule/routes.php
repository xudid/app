...
/*$this->router->get(
    '/roles/search',
    'roles_search',
    fn() => $app->render($controller->search())
);
$this->router->post(
    '/roles/search',
    'roles_searchresult',
    function () use ($app, $controller) {
        return $app->render($controller->search());
    }
);*/
...
return [
    ...
    [
        ...
        'path' => '/roles/new',
        'callback' => function () {
            return App::render(App::get(RolesController::class)->new());
        },
    ],
    [
        'action' => [
    ...
    [
        ...
        'callback' => function ($params) {
            $id = $params['id'];
            return App::get(RolesController::class)->editModules($id);
        },
        'params' => [['id' => '[0-9]+']]
    ],
    [
